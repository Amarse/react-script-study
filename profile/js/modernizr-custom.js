...
!(function (e, n, t) {
    function a(e) {
        ...
        Modernizr._config.enableClasses &&
            ((n += " " + t + e.join(" " + t)),
            f ? (l.className.baseVal = n) : (l.className = n));
    }
    function o(e, n) {
        return typeof e === n;
    }
    function r() {
        ...
        for (var f in s)
            if (s.hasOwnProperty(f)) {
                ...
                for (
                    a = o(n.fn, "function") ? n.fn() : n.fn, r = 0;
                    r < e.length;
                    r++
                )
                    (c = e[r]),
    ...
    f ||
        !(function (e, n) {
            function t(e, n) {
                ...
                return (
                    (t.innerHTML = "x<style>" + n + "</style>"),
                    a.insertBefore(t.lastChild, a.firstChild)
                );
            }
            function a() {
                var e = E.elements;
            ...
            function s(e, t) {
                ...
                t = t || r(e);
                for (
                    var o = t.frag.cloneNode(), i = 0, s = a(), c = s.length;
                    c > i;
                    i++
                )
                    o.createElement(s[i]);
